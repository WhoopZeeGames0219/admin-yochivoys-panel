 ...
 * tslint:disable
 */ 
var styles = ["#card[_ngcontent-%COMP%] {\r\n    background-color: white;\r\n    border-radius: 12px;\r\n    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\r\n}\n/*# sourceMappingURL=data:application/json;base64, */"];
...
class UsersComponent {
    constructor(api, spinner, router, cdr, http) {
        this.api = api;
        ...
        this.dummy = Array(10);
        this.dummyUsers = [];
        this.filteredUsers = []; // Usuarios filtrados para mostrar en la tabla
    ...
    search(string) {
        ...
        this.filteredUsers = this.users.filter((user) => user.fullname.toLowerCase().includes(string.toLowerCase()));
        this.resetChanges();
