...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["coupons-coupons-module-ngfactory"], {
  ...
  function srcAppCouponsCouponsComponentNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function View_CouponsComponent_0(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 4, "ngx-spinner", [["color", "#e74c3c"], ["type", "ball-pulse-sync"]], null, null, null, _node_modules_ngx_spinner_ngx_spinner_ngfactory__WEBPACK_IMPORTED_MODULE_4__["View_NgxSpinnerComponent_0"], _node_modules_ngx_spinner_ngx_spinner_ngfactory__WEBPACK_IMPORTED_MODULE_4__["RenderType_NgxSpinnerComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 770048, null, 0, ngx_spinner__WEBPACK_IMPORTED_MODULE_5__["NgxSpinnerComponent"], [ngx_spinner__WEBPACK_IMPORTED_MODULE_5__["NgxSpinnerService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]], {
        ...
        var currVal_4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 15, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 16).transform("Nuevo Cupon"));
        ...
        var currVal_6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 23, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 24).transform("Search coupons")) || "\xA0";
  ...
  function srcAppCouponsCouponsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CouponsComponent = /*#__PURE__*/function () {
      function CouponsComponent(router, api, spinner, http) {
        var _this = this;
      ...
      _createClass(CouponsComponent, [{
        ...
        value: function getOffers() {
          ...
          this.api.getOffers().then(function (data) {
            ...
            if (data && data.length) {
              _this2.list = data;
              _this2.dummyCupons = data;
            }

            _this2.filteredCupons = _toConsumableArray(_this2.list); // Inicializamos los filtrados
        ...
        value: function open(item) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
            ...
            if (data && data.value) {
              ...
              _this3.api.updateOffers(item).then(function (data) {
                _this3.spinner.hide();
        ...
        value: function search(string) {
          ...
          this.filteredCupons = this.list.filter(function (cupon) {
            return cupon.code.toLowerCase().includes(string.toLowerCase());
          });
          this.resetChanges();
        ...
        value: function generateReport() {
          var doc = new jspdf__WEBPACK_IMPORTED_MODULE_3___default.a(); // Agregar título al reporte

          doc.setFontSize(16);
          doc.text('Reporte de Cupones', 105, 10, {
            align: 'center'
          });
          doc.setFontSize(12);
          doc.text("Filtro aplicado: \"".concat(this.searchQuery || 'Todos los cupones', "\""), 105, 20, {
            align: 'center'
          ...
          var tableData = this.list.map(function (cupon) {
            return [cupon.code, cupon.discout, cupon.expire, cupon.min, cupon.type, cupon.upto, cupon.status, cupon.available.map(function (restaurant) {
