...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["drivers-drivers-module-ngfactory"], {
  ...
  function srcAppDriversDriversComponentNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function View_DriversComponent_0(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 4, "ngx-spinner", [["color", "#e74c3c"], ["type", "ball-pulse-sync"]], null, null, null, _node_modules_ngx_spinner_ngx_spinner_ngfactory__WEBPACK_IMPORTED_MODULE_5__["View_NgxSpinnerComponent_0"], _node_modules_ngx_spinner_ngx_spinner_ngfactory__WEBPACK_IMPORTED_MODULE_5__["RenderType_NgxSpinnerComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 770048, null, 0, ngx_spinner__WEBPACK_IMPORTED_MODULE_6__["NgxSpinnerComponent"], [ngx_spinner__WEBPACK_IMPORTED_MODULE_6__["NgxSpinnerService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]], {
        ...
        var currVal_4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 15, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 16).transform("Nuevo Repartidor"));

        _ck(_v, 15, 0, currVal_4);

        var currVal_5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 18, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 19).transform("Generar Reporte"));

        _ck(_v, 18, 0, currVal_5);

        var currVal_6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 23, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 24).transform("Search Driver")) || "\xA0";
  ...
  function srcAppDriversDriversComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DriversComponent = /*#__PURE__*/function () {
      function DriversComponent(api, router, spinner, http) {
        var _this = this;
      ...
      _createClass(DriversComponent, [{
        ...
        value: function getUsers() {
          ...
          this.api.getUsers().then(function (data) {
            ...
            console.log(_this2.drivers); // Obtener ciudades después de cargar usuarios
        ...
        value: function getCities() {
          ...
          this.api.getCities().then(function (data) {
            _this3.cities = data; // Llenar la lista de ciudades
          })["catch"](function (error) {
        ...
        value: function changeStatus(item) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire({
            ...
            if (data && data.value) {
              ...
              _this4.api.updateProfile(item.uid, item).then(function (data) {
                _this4.spinner.hide();
        ...
        value: function generateReport() {
          ...
          var doc = new jspdf__WEBPACK_IMPORTED_MODULE_2___default.a(); // Agregar título al reporte

          doc.setFontSize(16);
          doc.text('Reporte de Repartidores', 105, 10, {
            align: 'center'
          });
          doc.setFontSize(12);
          doc.text("Filtro aplicado: \"".concat(this.searchQuery || 'Todos los Repartidores', "\""), 105, 20, {
            align: 'center'
          ...
          var tableData = this.drivers.map(function (driver) {
            var city = _this5.cities.find(function (c) {
              return c.id === driver.city;
            }); // Obtener el nombre de la ciudad


            return [driver.fullname, driver.email, driver.phone, driver.status, driver.descriptions, city ? city.name : 'Ciudad no asignada'];
          ...
          this.http.get('assets/images/dashboard/yochivoy_logo.png', {
            ...
            reader.onload = function () {
              var base64Image = reader.result; // Agregar imagen al reporte
        ...
        key: "driversWithCityNames",
        get: function get() {
          var _this6 = this;

          return this.drivers.map(function (driver) {
            var city = _this6.cities.find(function (c) {
              return c.id === driver.city;
            });
