...
class DashboardComponent {
    constructor(api, router, route, http) {
        this.api = api;
        this.router = router;
        this.route = route;
        this.http = http;
    ...
    getMonthlyOrdersData() {
        ...
        const monthlyOrdersArray = Object.keys(totalOrders).map(monthYear => {
            return [
                monthYear,
                totalOrders[monthYear] || 0,
                deliveredData[monthYear] || 0,
    ...
    generateReport() {
        ...
        this.reviews.sort((a, b) => new Date(b.createdAt.split('/').reverse().join('-')).getTime() -
